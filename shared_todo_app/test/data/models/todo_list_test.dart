...
void main() {
  group('TodoList Model Tests', () {
    ...
    test('should handle todo list with special characters in title', () {
      ...
      final mapWithSpecialTitle = TestFixtures.createTodoListMap(title: specialTitle);
    ...
    test('should handle todo list with special characters in description', () {
      ...
      final mapWithSpecialDesc = TestFixtures.createTodoListMap(desc: specialDesc);
    ...
    test('should handle custom role values', () {
      ...
      final mapWithCustomRole = TestFixtures.createTodoListMap(role: customRole);
    ...
    test('should handle unicode and emoji in title', () {
      ...
      final mapWithUnicode = TestFixtures.createTodoListMap(title: unicodeTitle);
    ...
    test('should handle newlines in description', () {
      ...
      final mapWithNewlines = TestFixtures.createTodoListMap(desc: descWithNewlines);
