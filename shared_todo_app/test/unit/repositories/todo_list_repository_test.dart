...
void main() {
  group('TodoListRepository', () {
    test('can be instantiated with mock client', () {
      ...
      // Act
      final repository = TodoListRepository(client: mockClient);

      // Assert
      expect(repository, isNotNull);
      expect(repository, isA<TodoListRepository>());
    });
    ...
    test('can create multiple instances with different mocks', () {
      ...
      // Act
      final repo1 = TodoListRepository(client: mockClient1);
      final repo2 = TodoListRepository(client: mockClient2);
