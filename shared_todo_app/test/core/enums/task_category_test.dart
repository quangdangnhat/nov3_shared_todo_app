...
void main() {
  group('TaskCategory (core/enums) Tests', () {
    group('Enum Values', () {
    ...
    group('Difference from data/models version', () {
      test('filterLabel should have lowercase "today" for dueToday', () {
        // This version uses "Expire today" vs data/models version uses "Expire Today"
        expect(TaskCategory.dueToday.filterLabel, 'Expire today');
      });
    });
  });
