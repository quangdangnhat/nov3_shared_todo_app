...
void main() {
  group('SnackbarUtils Tests', () {
    group('showErrorSnackBar', () {
      ...
      testWidgets('should display snackbar at bottom of screen', (tester) async {
        // Arrange
      ...
      testWidgets('should handle long error messages', (tester) async {
        // Arrange
        const longMessage = 'This is a very long error message that might need to wrap to multiple lines in the snackbar';
        late BuildContext capturedContext;
    ...
    group('showSuccessSnackBar', () {
      testWidgets('should display success snackbar with message', (tester) async {
        // Arrange
      ...
      testWidgets('should handle long success messages', (tester) async {
        // Arrange
        const longMessage = 'Your operation has been completed successfully and all changes have been saved';
        late BuildContext capturedContext;
