  ...
  group('TreeStyleUtils Tests', () {
    ...
    group('getIconColor', () {
      test('should return primary color for todoList in light theme', () {
        final color =
            TreeStyleUtils.getIconColor(NodeType.todoList, lightTheme);
      ...
      test('should return different colors for folder in light vs dark theme',
          () {
        final lightColor =
            TreeStyleUtils.getIconColor(NodeType.folder, lightTheme);
        final darkColor =
            TreeStyleUtils.getIconColor(NodeType.folder, darkTheme);
      ...
      test('should return different colors for task in light vs dark theme',
          () {
        final lightColor =
            TreeStyleUtils.getIconColor(NodeType.task, lightTheme);
    ...
    group('getBackgroundColor', () {
      test('should return surface variant for todoList in light theme', () {
        final color =
            TreeStyleUtils.getBackgroundColor(NodeType.todoList, lightTheme);
        expect(color, lightTheme.colorScheme.surfaceVariant);
      });

      test('should return surface with opacity for todoList in dark theme', () {
        final color =
            TreeStyleUtils.getBackgroundColor(NodeType.todoList, darkTheme);
        expect(color, darkTheme.colorScheme.surface.withOpacity(0.8));
      });

      test('should return surface color for folder', () {
        final lightColor =
            TreeStyleUtils.getBackgroundColor(NodeType.folder, lightTheme);
        final darkColor =
            TreeStyleUtils.getBackgroundColor(NodeType.folder, darkTheme);
      ...
      test('should return surface color for task', () {
        final lightColor =
            TreeStyleUtils.getBackgroundColor(NodeType.task, lightTheme);
        final darkColor =
            TreeStyleUtils.getBackgroundColor(NodeType.task, darkTheme);
    ...
    group('getTitleFontWeight', () {
      ...
      test('todoList should have heavier weight than folder', () {
        final todoListWeight =
            TreeStyleUtils.getTitleFontWeight(NodeType.todoList);
    ...
    group('Consistency', () {
      ...
      test('all methods should handle all NodeType values', () {
        for (final type in NodeType.values) {
          ...
          expect(() => TreeStyleUtils.getIconColor(type, lightTheme),
              returnsNormally);
          expect(() => TreeStyleUtils.getBackgroundColor(type, lightTheme),
              returnsNormally);
          expect(() => TreeStyleUtils.getTitleFontSize(type), returnsNormally);
          expect(
              () => TreeStyleUtils.getTitleFontWeight(type), returnsNormally);
