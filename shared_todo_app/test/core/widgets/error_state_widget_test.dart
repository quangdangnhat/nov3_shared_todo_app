...
void main() {
  group('ErrorStateWidget Tests', () {
    ...
    testWidgets('should display default title when not provided', (tester) async {
      // Act
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
    ...
    testWidgets('should prioritize message over error when both provided', (tester) async {
      // Arrange
    ...
    testWidgets('should call onRetry when retry button pressed', (tester) async {
      // Arrange
      bool retryPressed = false;
    ...
    testWidgets('should display custom retry label when provided', (tester) async {
      // Arrange
