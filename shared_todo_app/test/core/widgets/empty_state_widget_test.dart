...
void main() {
  group('EmptyStateWidget Tests', () {
    ...
    testWidgets('should use theme colors with opacity for icon',
        (tester) async {
      // Act
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('should display all elements together', (tester) async {
      ...
      expect(
          find.text('Get started by creating your first task'), findsOneWidget);
    ...
    testWidgets('should handle long subtitle text', (tester) async {
      // Arrange
      const longSubtitle =
          'This is a very long subtitle with lots of text that explains what the user should do';
