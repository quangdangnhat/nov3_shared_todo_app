...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Builder( // Usiamo Builder per ottenere un contesto valido per GoRouter e SnackBar
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _isLoading
                        ...
                        : ElevatedButton(
                            onPressed: () => _submitSignUp(scaffoldContext), // Passa il contesto
                    ...
                    const SizedBox(height: 16),
                    TextButton(
                      onPressed: () => _navigateToLogin(scaffoldContext), // Passa il contesto
