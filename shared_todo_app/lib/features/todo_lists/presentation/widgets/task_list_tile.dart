...
class TaskListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isOverdue = task.dueDate.isBefore(DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day)) && task.status != 'Done';
    ...
    return Card(
      ...
      child: Padding( // Aggiunto Padding per separare contenuto e card
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Wrap( // Wrap per andare a capo se non c'è spazio
                 ...
                 children: ['To Do', 'In Progress', 'Done'].map((status) {
                    ...
                    return FilterChip(
                      ...
                      selectedColor: Theme.of(context).colorScheme.primary,
                       ...
                       shape: StadiumBorder(side: BorderSide(color: Colors.grey.withOpacity(0.3))),
                     );
                  }).toList(),
               ),
            ),
