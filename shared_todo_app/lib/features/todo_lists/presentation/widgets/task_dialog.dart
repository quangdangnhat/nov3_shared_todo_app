...
class _TaskDialogState extends State<TaskDialog> {
  ...
  void initState() {
    ...
    if (widget.taskToEdit != null) {
      ...
      _recurrenceType =
          RecurrenceType.fromString(widget.taskToEdit!.recurrenceType);
      debugPrint(
          '🔍 TaskDialog: Loading recurring state - isRecurring: $_isRecurring, recurrenceType: ${_recurrenceType.value}');
    }
  }
  ...
  Future<void> _submit() async {
    ...
    try {
      if (_isEditing) {
        ...
        debugPrint(
            '💾 TaskDialog: Saving task - isRecurring: $_isRecurring, recurrenceType: $recurrenceValue');
            ...
            children: [
              ...
              RecurrenceSelector(
                ...
                onRecurringChanged: (value) {
                  debugPrint(
                      '🔄 TaskDialog: Recurring checkbox changed to: $value');
                  setState(() => _isRecurring = value);
                },
                onRecurrenceTypeChanged: (type) {
                  debugPrint(
                      '🔄 TaskDialog: Recurrence type changed to: ${type.value}');
